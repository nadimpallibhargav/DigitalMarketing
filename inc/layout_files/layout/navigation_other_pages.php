<!-- Main navbar -->
<nav class="navbar nav_other_pages navbar-expand-md navbar-warning fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" target="_blank" xhref="<?php echo URL_ROOT; ?>inc/layout_files/pages/about.php">About Us <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown" style="background:transparent;">
                    ...
                    <div class="dropdown-menu services_dropdown">
                            <a class="dropdown-item" target="_blank" href="<?php echo URL_ROOT; ?>inc/layout_files/pages/service_sections/seo.php">SEO</a>
                            <a class="dropdown-item" target="_blank" href="<?php echo URL_ROOT; ?>inc/layout_files/pages/service_sections/smo.php">SMO</a>
                ...
                <li class="nav-item active">
                    <a class="nav-link" target="_blank" href="<?php echo URL_ROOT; ?>inc/layout_files/pages/contact_us.php">Contact Us<span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
